...
a persistence unit "servidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "servidor\pom.xml":
...
artifact ("servidor.war") is already built. You can build
